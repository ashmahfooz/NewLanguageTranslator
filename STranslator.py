...
targetedLang=st.selectbox("Choose language",list(languages.keys()))

if st.button("Translate"):
    if sourceText:
        translation=translator.translate(sourceText,dest=languages[targetedLang])
        st.write(f"Translated Text:{translation.text}")
    else:
        st.write("Enter your source text")
